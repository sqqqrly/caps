 ...
 *  Source Date:    %H% - %T%
 *
 *  Description:  Multifunction CAPS Message Processor.  Purges task table
 *                of entries which are longer running.  Default is 10 mins.
 *
 *  Called:   kernel2  [-timeout=xxx]
 *-------------------------------------------------------------------------*
 *                            Revision history                             |
 *-------------+-----------------------------------------------------------*
 ...
 *-------------------------------------------------------------------------*/
static char kernel2_c[] = "%Z% %M% %I% (%G% - %U%)";
...
extern   long kernel_purge();             /* watchdog routine                */
...
char **argv;
{
  ...
  putenv("_=kernel2");                    /* store name of self              */
