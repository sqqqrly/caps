 ...
 *                  tote_packing_list.c for Tote Integrity. 
 *
 *-------------------------------------------------------------------------*
 *                            Revision history                             |
 *-------------+-----------------------------------------------------------*
...
before_each_page()
{
  ...
  aplace("Mod I - Store Manifest", 22, 3, 1);
...
/*  if (of_rec->of_pl == 3) aplace(" - Refrigerated Items", 21, 3, 31); */
  ...
  aplace("Tote  #", 7, 3, 62);
  nplace(box_number, "99999999", 3, 69);
  aplace(udate, 8, 4, 62);
  aplace("Page", 4, 5, 62);
  nplace(page, "Z9", 5, 67);
  aplace("of", 2, 5, 70);
  nplace(last_page, "Z9", 5, 73);
  
  aplace("List of Items Shipped", 21, 6, 1);
  aplace("(* Short Items)", 15, 6, 26);
  
  aplace("Eckerd Item Number", 18, 8, 1);
  aplace("Description", 11, 8, 21);
  aplace("Qty Ordered", 11, 8, 52); 
  aplace("Qty Shipped", 11, 8, 65);
...
before_each_short_page()
{
 ...
 if (of_rec->of_pl == 3) aplace(" - Refrigerated Items", 21, 3, 31);
  ...
  aplace("List of Items Ordered but Short", 31, 6, 1);
